...
import BasetarificationEditPage from 'pages/basetarification/Edit';
...
const BasetarificationViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<BasetarificationEditPage isSubPage apiPath={`/basetarification/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="BasetarificationViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('baseTarificationDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div className="col">
                                ...
                                <div className="mb-3 grid ">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('dateApplication')}</div>
                                                <div className="font-bold">{ item.dt_application }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('periodicit')}</div>
                                                <div className="font-bold">{ item.periodicite }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                ...
                                                <div className="font-bold">{ item.montant }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('dtFin')}</div>
                                                <div className="font-bold">{ item.dt_fin }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                ...
                                                <div className="font-bold">{item.id_residence && <Button className="p-button-text" icon="pi pi-eye" label={$t('residenceDetail')} onClick={() => app.openPageDialog(<ResidenceViewPage isSubPage apiPath={`/residence/view/${item.id_residence}`} />, {closeBtn: true })} /> }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
...
BasetarificationViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'basetarification',
	apiPath: 'basetarification/view',
	routeName: 'basetarificationview',
...
export default BasetarificationViewPage;
