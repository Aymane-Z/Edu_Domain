...
const GarantieEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="GarantieEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editGarantie')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div className="col-12">
                                        <div className="formgrid grid">
                                            ...
                                            <div className="col-12 md:col-9">
                                                <DataSource   apiPath="components_data/id_garant_option_list_2"  >
                                                    {
                                                    ({ response }) => 
                                                    <>
...
GarantieEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'garantie',
	apiPath: 'garantie/edit',
	routeName: 'garantieedit',
...
export default GarantieEditPage;
