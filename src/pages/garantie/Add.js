...
const GarantieAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="GarantieAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewGarantie')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
GarantieAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'garantie',
	apiPath: 'garantie/add',
	routeName: 'garantieadd',
...
export default GarantieAddPage;
