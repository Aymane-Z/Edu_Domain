...
import GarantieEditPage from 'pages/garantie/Edit';
...
const GarantieViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<GarantieEditPage isSubPage apiPath={`/garantie/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="GarantieViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('garantieDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('garant')}</div>
                                        <div className="font-bold">{item.id_garant && <Button className="p-button-text" icon="pi pi-eye" label={item.garant_denomination} onClick={() => app.openPageDialog(<GarantViewPage isSubPage apiPath={`/garant/view/${item.id_garant}`} />, {closeBtn: true })} /> }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
...
GarantieViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'garantie',
	apiPath: 'garantie/view',
	routeName: 'garantieview',
...
export default GarantieViewPage;
