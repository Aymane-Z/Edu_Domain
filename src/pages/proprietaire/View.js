...
import ProprietaireEditPage from 'pages/proprietaire/Edit';
import useApp from 'hooks/useApp';
import useAuth from 'hooks/useAuth';

import useViewPage from 'hooks/useViewPage';
import MasterDetailPages from './MasterDetailPages';
const ProprietaireViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<ProprietaireEditPage isSubPage apiPath={`/proprietaire/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="ProprietaireViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('proprietaireDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
ProprietaireViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'proprietaire',
	apiPath: 'proprietaire/view',
	routeName: 'proprietaireview',
...
export default ProprietaireViewPage;
