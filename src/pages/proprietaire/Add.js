...
const ProprietaireAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="ProprietaireAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewProprietaire')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
ProprietaireAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'proprietaire',
	apiPath: 'proprietaire/add',
	routeName: 'proprietaireadd',
...
export default ProprietaireAddPage;
