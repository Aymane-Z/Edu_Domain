...
const ReclamationTraitementPage = (props) => {
		const auth = useAuth();
	const app = useApp();
...
const getStatusColor = (status) => {
  ...
  switch (status.toLowerCase()) {
	...
	return (
<main id="ReclamationTraitementPage" className="main-page">
    { (props.showHeader) && 
...
ReclamationTraitementPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'reclamation',
	apiPath: 'reclamation/traitement',
	routeName: 'reclamationtraitement',
...
export default ReclamationTraitementPage;
