...
import ReclamationEditPage from 'pages/reclamation/Edit';
...
const ReclamationViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<ReclamationEditPage isSubPage apiPath={`/reclamation/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="ReclamationViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('reclamationDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('dossierDeLocation')}</div>
                                        <div className="font-bold">{item.id_dossierlocation && <Button className="p-button-text" icon="pi pi-eye" label={$t('dossierDeLocation')} onClick={() => app.openPageDialog(<DossierlocationViewPage isSubPage apiPath={`/dossierlocation/view/${item.id_dossierlocation}`} />, {closeBtn: true })} /> }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('dateResolue')}</div>
                                        <div className="font-bold">{ item.date_resolue }</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
ReclamationViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'reclamation',
	apiPath: 'reclamation/view',
	routeName: 'reclamationview',
...
export default ReclamationViewPage;
