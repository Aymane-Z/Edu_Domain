...
const ReclamationResoluePage = (props) => {
		const auth = useAuth();
	const app = useApp();
...
const getStatusColor = (status) => {
  ...
  switch (status.toLowerCase()) {
	...
	return (
<main id="ReclamationResoluePage" className="main-page">
    { (props.showHeader) && 
...
ReclamationResoluePage.defaultProps = {
	primaryKey: 'id',
	pageName: 'reclamation',
	apiPath: 'reclamation/resolue',
	routeName: 'reclamationresolue',
...
export default ReclamationResoluePage;
