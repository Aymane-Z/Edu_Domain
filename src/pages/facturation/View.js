...
import FacturationEditPage from 'pages/facturation/Edit';
...
const FacturationViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<FacturationEditPage isSubPage apiPath={`/facturation/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="FacturationViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('facturationDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div className="col">
                                ...
                                <div className="mb-3 grid ">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('dateFacturation')}</div>
                                                <div className="font-bold">{ item.dt_facturation }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                ...
                                                <div className="font-bold">{item.user_id && <Button className="p-button-text" icon="pi pi-eye" label={$t('usersnodeDetail')} onClick={() => app.openPageDialog(<UsersnodeViewPage isSubPage apiPath={`/usersnode/view/${item.user_id}`} />, {closeBtn: true })} /> }</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
FacturationViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'facturation',
	apiPath: 'facturation/view',
	routeName: 'facturationview',
...
export default FacturationViewPage;
