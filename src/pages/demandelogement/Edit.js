...
const DemandelogementEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="DemandelogementEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editDemandeLogement')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
DemandelogementEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'demandelogement',
	apiPath: 'demandelogement/edit',
	routeName: 'demandelogementedit',
...
export default DemandelogementEditPage;
