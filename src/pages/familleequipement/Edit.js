...
const FamilleequipementEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="FamilleequipementEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editFamilleEquipement')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
FamilleequipementEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'familleequipement',
	apiPath: 'familleequipement/edit',
	routeName: 'familleequipementedit',
...
export default FamilleequipementEditPage;
