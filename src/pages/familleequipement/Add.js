...
const FamilleequipementAddPage = (props) => {
		const app = useApp();
	...
	function afterSubmit(response){
		...
		if(app.isDialogOpen()){
			...
			app.navigate(`/familleequipement`);
		}
	}
	...
	if(pageReady){
		return (
<main id="FamilleequipementAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewFamilleEquipement')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
FamilleequipementAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'familleequipement',
	apiPath: 'familleequipement/add',
	routeName: 'familleequipementadd',
...
export default FamilleequipementAddPage;
