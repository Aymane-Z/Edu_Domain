...
import FamilleequipementEditPage from 'pages/familleequipement/Edit';
import useApp from 'hooks/useApp';
import useAuth from 'hooks/useAuth';

import useViewPage from 'hooks/useViewPage';
import MasterDetailPages from './MasterDetailPages';
const FamilleequipementViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<FamilleequipementEditPage isSubPage apiPath={`/familleequipement/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="FamilleequipementViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('familleEquipementDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
FamilleequipementViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'familleequipement',
	apiPath: 'familleequipement/view',
	routeName: 'familleequipementview',
...
export default FamilleequipementViewPage;
