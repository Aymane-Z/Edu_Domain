...
const FamilleuniteAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="FamilleuniteAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewFamilleUnite')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
FamilleuniteAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'familleunite',
	apiPath: 'familleunite/add',
	routeName: 'familleuniteadd',
...
export default FamilleuniteAddPage;
