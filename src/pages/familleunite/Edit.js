...
const FamilleuniteEditPage = (props) => {
		const app = useApp();
	...
	const validationSchema = yup.object().shape({
		...
		prix: yup.number().nullable().label($t('prix')),
	...
	if(pageReady){
		return (
<main id="FamilleuniteEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editFamilleUnite')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div className="grid">
                                    ...
                                    <div className="col-12">
                                        <div className="formgrid grid">
                                            ...
                                            <div className="col-12 md:col-9">
                                                <InputText name="prix"  onChange={formik.handleChange}  value={formik.values.prix}   label={$t('prix')} type="number" placeholder={$t('enterPrix')}  min={0}  step={0.1}    className={inputClassName(formik?.errors?.prix)} />
                                                <ErrorMessage name="prix" component="span" className="p-error" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12">
...
FamilleuniteEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'familleunite',
	apiPath: 'familleunite/edit',
	routeName: 'familleuniteedit',
...
export default FamilleuniteEditPage;
