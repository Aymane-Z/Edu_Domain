...
import LignesfactureEditPage from 'pages/lignesfacture/Edit';
import useApp from 'hooks/useApp';
import useAuth from 'hooks/useAuth';
import useUtils from 'hooks/useUtils';

import useViewPage from 'hooks/useViewPage';
const LignesfactureViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<LignesfactureEditPage isSubPage apiPath={`/lignesfacture/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="LignesfactureViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('lignesFactureDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
LignesfactureViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'lignesfacture',
	apiPath: 'lignesfacture/view',
	routeName: 'lignesfactureview',
...
export default LignesfactureViewPage;
