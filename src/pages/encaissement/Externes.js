...
import EncaissementNonvalidesPage from 'pages/encaissement/Nonvalides';
import EncaissementValidesPage from 'pages/encaissement/Valides';
...
const EncaissementExternesPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	const [TabPage361, setTabPage361] = useState('TabPage361Page1');
	...
	return (
<main id="EncaissementExternesPage" className="main-page">
    { (props.showHeader) && 
                ...
                <div className="grid ">
                    <div className="col comp-grid" >
                        <div className="card  s">
                            <TabView >
                                <TabPanel header={
                                    <div><span>En Attente</span></div>
                                    }>
                                    <div className="">
                                        { pageReady &&
                                        <EncaissementNonvalidesPage isSubPage  limit="10" showHeader={true} showBreadcrumbs={true} showFooter={true} paginate={true} >
                                        </EncaissementNonvalidesPage>
                                        }
                                    </div>
                                </TabPanel>
                                <TabPanel header={
                                    <div><span>Validés</span></div>
                                    }>
                                    <div className="">
                                        { pageReady &&
                                        <EncaissementValidesPage isSubPage  limit="10" showHeader={true} showBreadcrumbs={true} showFooter={true} paginate={true} >
                                        </EncaissementValidesPage>
                                        }
                                    </div>
                                </TabPanel>
                            </TabView>
...
EncaissementExternesPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'encaissement',
	apiPath: 'encaissement/externes',
	routeName: 'encaissementexternes',
...
export default EncaissementExternesPage;
