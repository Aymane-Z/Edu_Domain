...
const ChambredetailsListPage = (props) => {
	...
	function ExportData() {
		if (props.exportData && records.length) {
			const downloadFileName = `${utils.dateNow()}-chambredetails`;
			return (
				<div className="m-2">
	...
	return (
<main id="ChambredetailsListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title={$t('chambredetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                    ...
                    <div >
                        ...
                        <div className="page-records">
                            <DataTable 
                                ...
                                <Column  field="id_couloir" header={$t('idCouloir')}  sortable={true} ></Column>
                                <Column  field="id_pavillon" header={$t('idPavillon')}  sortable={true} ></Column>
...
ChambredetailsListPage.defaultProps = {
	primaryKey: '',
	pageName: 'chambredetails',
	apiPath: 'chambredetails/index',
	routeName: 'chambredetailslist',
...
export default ChambredetailsListPage;
