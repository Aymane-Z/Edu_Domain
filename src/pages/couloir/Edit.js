...
const CouloirEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="CouloirEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editCouloir')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
CouloirEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'couloir',
	apiPath: 'couloir/edit',
	routeName: 'couloiredit',
...
export default CouloirEditPage;
