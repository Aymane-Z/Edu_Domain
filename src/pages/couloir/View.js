...
import CouloirEditPage from 'pages/couloir/Edit';
...
const CouloirViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<CouloirEditPage isSubPage apiPath={`/couloir/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="CouloirViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('couloirDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div className="col">
                                ...
                                <div className="mb-3 grid ">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('nombreEntrees')}</div>
                                                <div className="font-bold">{ item.nombre_entrees }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                ...
                                                <div className="font-bold">{item.id_pavillon && <Button className="p-button-text" icon="pi pi-eye" label={item.pavillon_denomination} onClick={() => app.openPageDialog(<PavillonViewPage isSubPage apiPath={`/pavillon/view/${item.id_pavillon}`} />, {closeBtn: true })} /> }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('idEtage')}</div>
                                                <div className="font-bold">{item.id_etage && <Button className="p-button-text" icon="pi pi-eye" label={$t('etageDetail')} onClick={() => app.openPageDialog(<EtageViewPage isSubPage apiPath={`/etage/view/${item.id_etage}`} />, {closeBtn: true })} /> }</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
CouloirViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'couloir',
	apiPath: 'couloir/view',
	routeName: 'couloirview',
...
export default CouloirViewPage;
