...
const UnitelocationdetailsListPage = (props) => {
	...
	return (
<main id="UnitelocationdetailsListPage" className="main-page">
    { (props.showHeader) && 
                    ...
                    <div >
                        ...
                        <div className="page-records">
                            <DataTable 
                                ...
                                <Column  field="id_chambre" header={$t('idChambre')}  sortable={true} ></Column>
                                <Column  field="id_typechambre" header={$t('idTypechambre')}  sortable={true} ></Column>
...
UnitelocationdetailsListPage.defaultProps = {
	primaryKey: '',
	pageName: 'unitelocationdetails',
	apiPath: 'unitelocationdetails/index',
	routeName: 'unitelocationdetailslist',
...
export default UnitelocationdetailsListPage;
