...
import ContratEditPage from 'pages/contrat/Edit';
...
const ContratViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<ContratEditPage isSubPage apiPath={`/contrat/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="ContratViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('contratDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div className="mb-3 grid ">
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('refContrat')}</div>
                                                <div className="font-bold">{ item.ref_contrat }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('remise')}</div>
                                                <div className="font-bold">{ item.remise }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">{$t('franchize')}</div>
                                                <div className="font-bold">{ item.franchize }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
...
ContratViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'contrat',
	apiPath: 'contrat/view',
	routeName: 'contratview',
...
export default ContratViewPage;
