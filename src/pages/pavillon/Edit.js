...
const PavillonEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="PavillonEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editPavillon')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
PavillonEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'pavillon',
	apiPath: 'pavillon/edit',
	routeName: 'pavillonedit',
...
export default PavillonEditPage;
