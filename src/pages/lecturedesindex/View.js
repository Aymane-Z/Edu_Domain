...
import LecturedesindexEditPage from 'pages/lecturedesindex/Edit';
...
const LecturedesindexViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<LecturedesindexEditPage isSubPage apiPath={`/lecturedesindex/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="LecturedesindexViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('lectureDesIndexDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div className="mb-3 grid ">
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('moisConsommation')}</div>
                                        <div className="font-bold">{ item.mois_consommation }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('indexEauFroid')}</div>
                                        <div className="font-bold">{ item.index_eau_froid }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('indexEauChaud')}</div>
                                        <div className="font-bold">{ item.index_eau_chaud }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('indexElectricite')}</div>
                                        <div className="font-bold">{ item.index_electricite }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
...
LecturedesindexViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'lecturedesindex',
	apiPath: 'lecturedesindex/view',
	routeName: 'lecturedesindexview',
...
export default LecturedesindexViewPage;
