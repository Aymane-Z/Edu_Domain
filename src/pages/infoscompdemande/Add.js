...
const InfoscompdemandeAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="InfoscompdemandeAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewInfosCompDemande')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
InfoscompdemandeAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'infoscompdemande',
	apiPath: 'infoscompdemande/add',
	routeName: 'infoscompdemandeadd',
...
export default InfoscompdemandeAddPage;
