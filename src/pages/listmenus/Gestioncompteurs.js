...
const ListmenusGestioncompteursPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusGestioncompteursPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusGestioncompteursPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/gestioncompteurs',
	routeName: 'listmenusgestioncompteurs',
...
export default ListmenusGestioncompteursPage;
