...
const ListmenusListPage = (props) => {
	...
	return (
<main id="ListmenusListPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusListPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/index',
	routeName: 'listmenuslist',
...
export default ListmenusListPage;
