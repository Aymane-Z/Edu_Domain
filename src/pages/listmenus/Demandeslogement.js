...
const ListmenusDemandeslogementPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusDemandeslogementPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusDemandeslogementPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/demandeslogement',
	routeName: 'listmenusdemandeslogement',
...
export default ListmenusDemandeslogementPage;
