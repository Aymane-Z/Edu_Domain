...
const ListmenusClientsPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusClientsPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusClientsPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/clients',
	routeName: 'listmenusclients',
...
export default ListmenusClientsPage;
