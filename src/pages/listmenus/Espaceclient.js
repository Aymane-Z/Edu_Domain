...
const ListmenusEspaceclientPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusEspaceclientPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusEspaceclientPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/espaceclient',
	routeName: 'listmenusespaceclient',
...
export default ListmenusEspaceclientPage;
