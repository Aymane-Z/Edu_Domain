...
const ListmenusDossierslocationPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusDossierslocationPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusDossierslocationPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/dossierslocation',
	routeName: 'listmenusdossierslocation',
...
export default ListmenusDossierslocationPage;
