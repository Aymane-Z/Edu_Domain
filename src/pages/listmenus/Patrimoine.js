...
const ListmenusPatrimoinePage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusPatrimoinePage" className="main-page">
    { (props.showHeader) && 
...
ListmenusPatrimoinePage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/patrimoine',
	routeName: 'listmenuspatrimoine',
...
export default ListmenusPatrimoinePage;
