...
const ListmenusPersonnelPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	return (
<main id="ListmenusPersonnelPage" className="main-page">
    { (props.showHeader) && 
...
ListmenusPersonnelPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'listmenus',
	apiPath: 'listmenus/personnel',
	routeName: 'listmenuspersonnel',
...
export default ListmenusPersonnelPage;
