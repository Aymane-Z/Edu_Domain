...
import UtilisateursEditPage from 'pages/utilisateurs/Edit';

import useViewPage from 'hooks/useViewPage';
const UtilisateursViewPage = (props) => {
		const auth = useAuth();
	const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<UtilisateursEditPage isSubPage apiPath={`/utilisateurs/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="UtilisateursViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('utilisateurDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        ...
                                        <div className="font-bold">{ item.user_role_id }</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
UtilisateursViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'utilisateurs',
	apiPath: 'utilisateurs/view',
	routeName: 'utilisateursview',
...
export default UtilisateursViewPage;
