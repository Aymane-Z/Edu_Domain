...
const roleAbilities = {
  "admin": [
    "demandelogement/edit",
    "demandelogement/delete"
  ],
...
export function AuthProvider({ children }) {
	...
	const isResponsableResidence = userRole.toLowerCase() === 'responsable_residence';

	const isClient = userRole.toLowerCase() === 'client';

	const isCaissier = userRole.toLowerCase() === 'caissier';

	const isHotesseAccueil = userRole.toLowerCase() === 'hotesse_accueil';

	const isSuperviseurSecurite = userRole.toLowerCase() === 'superviseur_securite';

	const isChargeClientele = userRole.toLowerCase() === 'charge_clientele';

	const isResponsableTechnique = userRole.toLowerCase() === 'responsable_technique';

	const isClientTemp = userRole.toLowerCase() === 'client_temp';
	...
	const providerValue = {
		...
		canManage,
		isOwner,
		isAdmin, isResponsableResidence, isClient, isCaissier, isHotesseAccueil, isSuperviseurSecurite, isChargeClientele, isResponsableTechnique, isClientTemp
	}
